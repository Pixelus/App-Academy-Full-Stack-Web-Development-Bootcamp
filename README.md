...
### App Academy Prep Work & Independent Study
 ...
 * Cheat Sheet **[Ruby Essentials](https://cheatography.com/pixelus/cheat-sheets/ruby-essentials/pdf/)**, memo that I made during my Ruby programming language learning apprenctice.
 ...
 **Programming Fundamentals and Computer Science** | Numbers, Booleans, Strings, Variables, Methods, Conditionals, Loops, Arrays, Enumerables & Ranges, Nested Loops & 2D Arrays, Hashes, Advanced Problems | Completed | [Intro to Programming](https://github.com/Pixelus/App-Academy-Full-Stack-Web-Development-Bootcamp/tree/master/Intro%20To%20Programming) 
 **Software Engineering Foundations** | Ruby Environment Setup Terminal & Command Line, Visual Studio Code, WSL, Unbuntu, Git, Advanced Ruby, Scope & References, RSpec, Debugging, Blocks & Procs, Classes, Class Monkey Patching, Input/Output, Object-Oriented Programming, Recursion, Foundations Recap, Projects | In Progress | [Software Engineering Foundations](https://github.com/Pixelus/App-Academy-Full-Stack-Web-Development-Bootcamp/tree/master/Software%20Engineering%20Foundations)   
